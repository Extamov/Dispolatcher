...
1. Edit the file ``server-files/db.php`` and set the credentials of the database.

2. Edit the file ``server-files/mail.php`` and set the credentials for the mail system.
...
4. Import the SQL file ``extdispatcher.sql`` in ``server-files`` into the database.
